...
import (
	...
	apiv1beta1 "github.com/zf930530/quota-manager/api/v1beta1"
	versioned "github.com/zf930530/quota-manager/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/zf930530/quota-manager/pkg/generated/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/zf930530/quota-manager/pkg/generated/listers/core/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KmcV1beta1().Quotas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KmcV1beta1().Quotas(namespace).Watch(context.TODO(), options)
			},
		},
		&apiv1beta1.Quota{},
		resyncPeriod,
...
func (f *quotaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiv1beta1.Quota{}, f.defaultInformer)
}
