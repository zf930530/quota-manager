...
// +kubebuilder:rbac:groups=kmc.kmc.io,resources=quotas,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kmc.kmc.io,resources=quotas/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=kmc.kmc.io,resources=quotas/finalizers,verbs=update
